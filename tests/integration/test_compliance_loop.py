...
from audit.models import ReviewerStatus
...
from index_management.swapper import IndexSwapper, SwapResult
...
class TestIndexSwapper:
    ...
    async def test_index_swapper_swap_validates_new_index_before_committing(self):
        ...
        from index_management.watcher import IndexManifest
        ...
        with patch.object(swapper, "_download_from_s3", new_callable=AsyncMock, return_value="/tmp/test"), \
             patch("index_management.swapper.FAISSRetriever") as MockRetriever:
